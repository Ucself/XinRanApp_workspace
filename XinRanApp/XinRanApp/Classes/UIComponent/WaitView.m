...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) 
	{
        ...
        UIImage *image = [UIImage imageNamed:@"loading_bg"];
        ivBg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, image.size.width, image.size.height)];
        ivBg.image = image;
        [self addSubview:ivBg];
        
        image = [UIImage imageNamed:@"loading_icon"];
        ivLogo = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, image.size.width, image.size.height)];
        ivLogo.image = image;
        [ivBg addSubview:ivLogo];
        
        
        image = [UIImage imageNamed:@"loading_progress"];
        ivProgress = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, image.size.width, image.size.height)];
